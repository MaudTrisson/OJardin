 ...
 */
final class Version20230819154815 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE flowerbed ADD CONSTRAINT FK_AC0FEDC61D935652 FOREIGN KEY (plant_id) REFERENCES flowerbed_plant (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
