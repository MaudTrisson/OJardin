 ...
 */
final class Version20230819154947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE flowerbed ADD CONSTRAINT FK_AC0FEDC61D935652 FOREIGN KEY (plant_id) REFERENCES plant (id)');
